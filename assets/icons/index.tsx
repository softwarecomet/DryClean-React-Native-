...
export const HomeIconFill = (style: ImageStyle): IconElement<ImageProps> => {
  return (
...
export const QuestionCircleMark = (style: ImageStyle): IconElement<ImageProps> => {
  return (
    <Icon {...style} name='question-mark-circle-outline'/>
  );
};
export const RightIcon = (style: ImageStyle): IconElement<ImageProps> => {
  return (
