...
export const logoImage: ImageSource = {
  imageSource: require('./source/logo.png'),
};

export const dryIcon: ImageSource={
  imageSource:require("./source/dryicon.png")
};

export const clearIronIcon: ImageSource={
  imageSource:require("./source/iron2.png")
};
export const ironIcon: ImageSource={
  imageSource:require("./source/iron.png")
};